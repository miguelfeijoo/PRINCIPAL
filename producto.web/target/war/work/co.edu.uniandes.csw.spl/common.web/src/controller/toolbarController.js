define([], function() {
    App.Controller.ToolbarController = Backbone.View.extend({
        initialize: function() {
            ...
            this.events['click #' + this.model.get('componentId') + '-1Button'] = 'button1';
            this.events['click #' + this.model.get('componentId') + '-2Button'] = 'button2';
        ...
        button1: function(event) {
            Backbone.trigger(this.model.get('componentId') + '-toolbar-button1', event, this);
        },
        button2: function(event) {
            Backbone.trigger(this.model.get('componentId') + '-toolbar-button2', event, this);
        }
