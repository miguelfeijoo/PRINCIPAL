...
public class FacturaPersistenceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			entity.setNumeroFactura(generateRandom(Integer.class));
	...
	public void createFacturaTest(){
		...
		dto.setNumeroFactura(generateRandom(Integer.class));
		...
		Assert.assertEquals(dto.getNumeroFactura(), entity.getNumeroFactura());	
	...
	public void getFacturaTest(){
		...
		Assert.assertEquals(entity.getNumeroFactura(), dto.getNumeroFactura());
	...
	public void updateFacturaTest(){
		...
		Assert.assertEquals(dto.getNumeroFactura(), resp.getNumeroFactura());	
