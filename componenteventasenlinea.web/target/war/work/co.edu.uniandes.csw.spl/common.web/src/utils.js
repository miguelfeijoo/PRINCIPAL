define(['App', 'controller/messageController'], function(App, Messages) {
        ...
        $.each(a, function() {
            if (o[this.name] !== undefined) {
                ...
                if (converterName) {
                    ...
                    o[this.name] = converter.serialize(this.value, this);
                } else {
    ...
    App.Utils = App.Utils || {
        ...
        getComponentList: function(componentName, callBack) {
            var self = this;
            if (!this.cache[componentName]) {
                ...
                callBack(componentName, this.cache[componentName]);
            }
        },
