    ...
    App.Controller.SelectionController = Backbone.View.extend({
        initialize: function(options) {
            ...
            Backbone.on('showSelection', function(params) {
                self.showSelectionList(params);
            });

            Backbone.on('selection-add', function(params) {
                self.addSelectionList(params);
            });
            Backbone.on('selection-cancel', function(params) {
        ...
        _renderSelectionList: function(params) {
            ...
            $('#bgmodal').html(this.selectionListTemplate({'list': this.list.models, 'name':name, 'title':title}));
