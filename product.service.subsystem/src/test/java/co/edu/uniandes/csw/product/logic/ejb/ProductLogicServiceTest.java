...
public class ProductLogicServiceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			pdto.setImage(generateRandom(String.class));
			pdto.setPrice(generateRandom(Long.class));
	...
	public void createProductTest(){
		...
		ldto.setImage(generateRandom(String.class));
		ldto.setPrice(generateRandom(Long.class));
		...
		Assert.assertEquals(ldto.getImage(), pdto.getImage());	
		Assert.assertEquals(ldto.getPrice(), pdto.getPrice());	
	}
	...
	public void getProductTest(){
		...
		Assert.assertEquals(pdto.getImage(), ldto.getImage());
		Assert.assertEquals(pdto.getPrice(), ldto.getPrice());
	...
	public void updateProductTest(){
		...
		Assert.assertEquals(ldto.getImage(), resp.getImage());	
		Assert.assertEquals(ldto.getPrice(), resp.getPrice());	
	}
